...
public class PluginConf {
  ...
  **/
   ...
   * @return modulePath
  **/
  @ApiModelProperty(example = "github.com/alertify/server/plugin/example/echo", required = true, value = "The module path of the plugin.")
  ...
  **/
   ...
   * @return website
  **/
  @ApiModelProperty(example = "alertify.net", value = "The website of the plugin.")
